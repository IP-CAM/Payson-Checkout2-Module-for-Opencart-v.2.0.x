...
$_['entry_order_status_shipped'] = 'Orderstatus f√∂r skickad order';
$_['entry_order_status_canceled'] = 'Orderstatus f√∂r avbruten order';
$_['entry_order_status_refunded'] = 'Orderstatus f√∂r krediterad order';
$_['entry_geo_zone'] = 'Geo Zone';
$_['entry_status'] = 'Status';
$_['entry_sort_order'] = 'Sorteringsordning';
$_['entry_logg'] = 'Loggar';
$_['entry_totals_to_ignore'] = 'Ignorerade ordertill√§gg';

$_['text_request_phone'] = 'Aktivera telefonnummer';
$_['entry_phone'] = 'Telefonnummer';
$_['text_phone_yes'] = 'Ja';
$_['text_phone_no'] = 'Nej';
$_['entry_registered_customer'] = 'Kan anv√§ndas f√∂r att aktivera enbart registrerade kunder vid anv√§ndning av modulen Ajax Quick Checkout';
...
$_['text_color_scheme_blue'] = 'bl√•';
$_['text_color_scheme_gray'] = 'gr√•';
...
$_['entry_iframe_size_height'] = 'Storlek av iframe (h√∂jd)';
...
$_['entry_order_item_details_to_ignore'] = 'Ignorerade ordertill√§gg vid Payson';
...
$_['error_ignored_order_totals'] = 'Ange en kommaseparerad lista med ordertill√§gg som ej skall skickas till Payson';
...
$_['help_gui_verification'] = 'Kan anv√§ndas som en extra verifikation';
$_['help_request_phone'] = 'Enable telefonnummer';
$_['help_request_registered_customer'] = 'Kan anv√§ndas f√∂r att aktivera enbart registrerade kunder vid anv√§ndning av modulen Ajax Quick Checkout';
$_['help_color_scheme'] = 'Ange f√§rgen av schema';
$_['help_iframe_size_height'] = 'Ange h√∂jden av iframe';
...
$_['help_order_status_shipped'] = 'Meddela Payson att ordern har skickats.<br />V‰nligen kontrollera under Admin | Verktyg -> Logs att ordern har fÂtt status skickad i Payson innan den skickas till kunden.';
$_['help_order_status_canceled'] = 'Meddela Payson att ordern har avbrutits.<br />V‰nligen kontrollera under Admin | Verktyg -> Logs att ordern har fÂtt status cancelled  i Payson.';
$_['help_order_status_refunded'] = 'Meddela Payson att ordern ska krediteras.<br />V‰nligen kontrollera under Admin | Verktyg -> Logs att ordern har fÂtt status paidToAccount/Krediterad  i Payson.'; 
?>
