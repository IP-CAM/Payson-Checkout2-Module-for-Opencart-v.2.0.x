...
$_['text_title']  = '<img src="https://cdn.svea.com/webpay/payson/payson.png" style="width:150px;height:55px;clear:right" alt="Payson All in One - Visa, MasterCard, Direct bank" title="Payson" />';
